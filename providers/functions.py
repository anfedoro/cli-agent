...
from . import gemini, lmstudio, openai
...
GET_AVAILABLE_TOOLS = {
    ...
    "lmstudio": lmstudio.get_available_tools,
}
...
GET_DISPLAY_NAME = {
    ...
    "lmstudio": lmstudio.get_display_name,
}
...
EXTRACT_FUNCTION_CALLS = {
    ...
    "lmstudio": lmstudio.extract_function_calls,
}
...
ADD_FUNCTION_RESULT_TO_MESSAGES = {
    ...
    "lmstudio": lmstudio.add_function_result_to_messages,
}
...
EXTRACT_USAGE_INFO = {
    ...
    "lmstudio": lmstudio.extract_usage_info,
}
...
GET_RESPONSE_TEXT = {
    ...
    "lmstudio": lmstudio.get_response_text,
}
